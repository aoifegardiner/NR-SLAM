...
Stir::Stir(const std::string &video_path) {
...
absl::StatusOr<cv::Mat> Stir::GetImage(const int idx) {
...
bool Stir::SplitVideoIntoFrames(const std::string& dataset_path, const std::string& video_path) {
    // Opens the video.
