/****************************************************************************
** Meta object code from reading C++ file 'properties_widget.h'
**
...
#include <memory>
#include "../../../../../../third_party/g2o/g2o/apps/g2o_viewer/properties_widget.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'properties_widget.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 17, 19), // "on_btnApply_clicked"
QT_MOC_LITERAL(2, 37, 0), // ""
QT_MOC_LITERAL(3, 38, 16) // "on_btnOK_clicked"

    },
    "PropertiesWidget\0on_btnApply_clicked\0"
    "\0on_btnOK_clicked"
};
...
void PropertiesWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->on_btnApply_clicked(); break;
...
void *PropertiesWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui::BasePropertiesWidget"))
        return static_cast< Ui::BasePropertiesWidget*>(this);
